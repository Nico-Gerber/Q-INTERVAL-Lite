    ...
    <Container maxWidth="lg">
      <Box sx={{ textAlign: 'center', mb: 2.5 }}>
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 1, mb: 1 }}>
          ...
          <Typography variant="subtitle1" fontWeight={700} sx={{ color: '#E8EEF8' }}>Q-INTERVAL-Lite+</Typography>
        </Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 0.75, mb: 2.5 }}>
        {TECH_STACK.map((tech) => (
          <Chip key={tech} label={tech} size="small"
            sx={{ backgroundColor: 'rgba(45,212,191,0.08)', color: 'rgba(255,255,255,0.5)', border: '1px solid rgba(45,212,191,0.15)', fontSize: '0.7rem', fontWeight: 500, transition: 'all 0.2s', '&:hover': { backgroundColor: 'rgba(45,212,191,0.15)', color: '#2DD4BF' } }}
          />
        ))}
      </Box>
