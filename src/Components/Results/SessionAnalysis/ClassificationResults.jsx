...
export default function ClassificationResults({
    ...
    /*
     * Per-view VLM explanation.
     *
     * viewData is stored in the parent so explanations survive
     ...
     * }
     */
    const currentExplanation = viewData?.[currentView];

    const [zoomModel, setZoomModel] = useState(null);
    ...
    const handleZoomMouseMove = (e) => {
        ...
        setZoomPan({
            x: panRef.current.originX +
                (e.clientX - panRef.current.startX),

            y: panRef.current.originY +
    ...
    const activeResult =
        currentModel === 'Quantum'
            ? qml
            : cnn;

    const activeView =
        activeResult?.views?.[currentView];
    ...
    const qmlView =
        qml?.views?.[currentView];

    const agree =
        cnnView?.result === qmlView?.result;
    ...
    const classes = [
        ...
        single:
            pct(
                activeView?.class_probabilities?.[label]
            ),

        cnn:
            pct(
                cnnView?.class_probabilities?.[label]
            ),

        qml:
            pct(
                qmlView?.class_probabilities?.[label]
            ),
    }));
        ...
        >
            ...
            >
                ...
                >
                    <Box
                        component="img"
                        src={baseSrc(currentView)}
                        alt={`${currentView} mammogram`}
                        sx={{
                            maxWidth: '100%',
                            maxHeight: '100%',
                            objectFit: 'contain',
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <TextField
                                                            multiline
                                                            minRows={2}
                                                            placeholder="Add context for this read — kept whether you confirm or override."
                                                            value={draftNote}
                                                            onChange={(e) =>
                                                                setDraftNote(
                                                                    e.target
                    ...
                    >
                        ...
                        {isBoth ? (
                            ...
                            >
                                {[
                                    ...
                                    {
                                        k: 'Confidence',
                                        v: `${pct(activeView.score).toFixed(2)}%`,
                                        c: t.text
                                    }
                                ].map(
                                    ({ k, v, c }) => (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    All classifications · {currentView}
                                </Label>
                            </Box>
                                                    ...
                                                    sx={{
                                                        ...
                                                        background:
                                                            verification?.status ===
                                                                ...
                                                                : STATUS_DONE,
                                                        boxShadow:
                                                            `0 0 5px 1px ${(verification?.status === 'pending'
                                                                ? STATUS_PENDING
                                                                : STATUS_DONE
                                                            )}88`
                                                    }}
                        ...
                        {/* ─────────────────────────────────────
                            ...
                            the overall LLM summary in the parent.
                           ───────────────────────────────────── */}
                        ...
                        >
                            ...
                            >
                                <Box
                                    ...
                                    alt={`${currentView} mammogram, enlarged`}
                                    draggable={false}
                                    sx={{
                                        maxWidth: '100%',
                                        maxHeight: '85vh',
